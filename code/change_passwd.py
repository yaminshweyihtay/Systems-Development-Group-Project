...
from main import set_password, TITLE_FONT
...
class ChangePswd(tk.Frame):
    ...
    def create_widgets(self):
        ...
        display = {"pswd": ttk.Label(frame, text="Enter Password:", font=TITLE_FONT),
                   "pswdInput": ttk.Entry(frame, textvariable=new_password_input, font=TITLE_FONT),
